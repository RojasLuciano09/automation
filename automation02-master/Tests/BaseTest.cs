...
namespace automation02.Tests
{
    public class Tests
    {
        ...
        public void Setup()
        {
            driver = new FirefoxDriver("C:\\Users\\l.rojas\\Desktop\\QA\\repoTrabajo\\automation\\dummyAutomation\\automation02-master\\drivers", getFirefoxOptions());
        ...
        private FirefoxOptions getFirefoxOptions()
        {
            ...
            options.SetPreference("pdfjs.disabled", true);  // disable the built-in PDF viewer
                                                            // options.AddArguments("--headless"); //able to close browser //disable to use browser
